import simulacion as sc
import Librerianueva as nc
import math
import numpy as np


def cuatro2(billar_matriz, ket, num):
    """solucion del ejercicio 4.4.2
    :parametro biliar_matriz: matriz adyacent a la bola de billar
    :parametro ket: estado inicial
    """
    solution = sc.system_clikcs(billar_matriz, ket, num)

    return solution


def cuatro1(matriz1, matriz2):
    """solucion del porblema 4.4.1
    :parametro matriz1: posible matriz unitaria
    :parametro matriz2: posible matriz unitaria
    :return: un booleano
    """
...
def eingenvalues_vectors(matriz_ob):
    ...
    :parametro matriz_ob: observable
...
def mediaandvar(matriz_ob, estado):
    ...
    :parametro matriz_ob: observavle
    :parametro estado: estado preparado
...
def observables(matriz_ob):
    ...
    :parametro matriz_ob: matriz posiblemente hermitiana
    :return: Booleana
    """
...
def amplitud_tran(ket, ket1):
    ...
    :parametro ket: vector estado 1
    :parametro ket1: vector estado 2
...
def prob_position(p, ket):
    ...
    :parametro p: posición
    :parametro ket: vector estado
    :return: probabilidad
    """
